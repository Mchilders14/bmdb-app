...
public class BmdbConsoleApp {
	...
	public static void main(String[] args) throws ParseException {
		...
		msg("Please enter Operating System to continue...");
		
		while (!operatingSystem.equalsIgnoreCase("MAC") && !operatingSystem.equalsIgnoreCase("WIN")) {
			operatingSystem = Console.getString("\nPlease Enter an operating system:\n(MAC)MACOSX\n(WIN)WINDOWS\n");
		}
